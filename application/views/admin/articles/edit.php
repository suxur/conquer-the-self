<h2><?php echo empty($article->id) ? 'Add a New Article' : 'Edit Article:'; ?></h2>
<?php echo empty($article->id) ? '' : '<h3>' . $article->title . '</h3>'; ?>
...
<?php echo form_open_multipart(); ?>
	<table class="table">
		...
		<tr>
			<td>Category:</td>
		<td><?php echo form_dropdown('category_id', array('4' => 'Article', '2' => '7 Days', '3' => 'Journey', '1' => 'Tips')); ?></td>
		</tr>
		<tr>
...
<script src="<?php echo site_url('js/articles.edit.min.js'); ?>"></script>
