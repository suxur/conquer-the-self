...
(function () {
    ...
    upload.on('click', function (e) {
        ...
        if (!!file.type.match(/image.*/)) {
            ...
            $.ajax({
                url: 'http://development.conquertheself.com/articles/upload_crop',
                type: 'POST',
                data: data,
                processData: false,
                contentType: false,
                success: function (res) {
                    ...
                    if (success === 'true') {
                        ...
                        img.attr('src', '../../img/uploads/' + msg).attr('alt', msg);
            ...
            success: function (res) {
                ...
                if (success === 'true') {
                    response.html('<div class="alert alert-success">' +
                                      ...
                                      '<strong>Success! </strong>The image ' + msg + ' has been successfully uploaded!' +
                                  '</div>');
                    filename.attr('value', 'http://localhost/img/uploads/articles/' + msg);
                }
            }
        });
    }
