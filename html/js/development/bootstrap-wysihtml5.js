        ...
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              ...
              "<ul class='dropdown-menu'>" +
                ...
                "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='div' tabindex='-1'>" + locale.font_styles.div + "</a></li>" +
                "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='php' tabindex='-1'>" + locale.font_styles.php + "</a></li>" +
              "</ul>" +
            "</li>";
        },
                        ...
                        "<div class='fileupload fileupload-new' data-provides='fileupload'>" +
                            "<div class='input-append image-upload'>" +
                                ...
                                "<span class='btn btn-file'>" +
                                    ...
                                    "<input type='file' id='input-upload-01'>" +
                                "</span>" +
                            "</div>" +
                            "<a href='#' class='btn fileupload-exists' data-dismiss='fileupload'>Remove</a>" +
                            "<button id='btn-upload-01' class='btn btn-success fileupload-exists' onclick='uploadImage()'><i class='icon-upload icon-white'></i> Upload</button>" +
                        "</div>" +
                        "<div id='response-01'></div>" +
                        "<input type='hidden' value='' id='filename-01' class='bootstrap-wysihtml5-insert-image-url'>" +
                    "</div>" +
                    "<div class='modal-footer'>" +
